# Trust Edge Bank - Modern Digital Banking

<div align="center">
  <img src="public/trustedge.png" alt="Trust Edge Bank Logo" width="120" height="120" />
...
**Trust Edge Bank** is a full-featured digital banking application built with modern web technologies. It provides a comprehensive banking experience including account management, KYC verification, transfers, refunds, card services, and a complete admin dashboard.
...
👉 **[TRUST EDGE_BANK_COMPLETE_SUMMARY.md](./TRUST EDGE_BANK_COMPLETE_SUMMARY.md)**
...
└── TRUST EDGE_BANK_COMPLETE_SUMMARY.md  # 📚 Complete documentation
```
...
- Email: support@trustedgebank.com
